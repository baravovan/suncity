package com.suncity.sun_cities.configuration;
...
public class DalCfg {
	...
	private static Logger log = Logger.getLogger(DalCfg.class.getName());
    ...
    public LocalSessionFactoryBean sessionFactory() throws ClassNotFoundException {
        ...
        sessionFactory.setPackagesToScan("com.suncity.sun_cities.model");
